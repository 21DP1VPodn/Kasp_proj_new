...
CREATE TABLE IF NOT EXISTS `backstories` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `author ID` bigint(20) DEFAULT NULL,
...
-- Дамп данных таблицы dnd_database.users: ~3 rows (приблизительно)
INSERT INTO `users` (`ID`, `user_id`, `username`, `password`, `Name`, `Email`, `admin?`, `Description`) VALUES
	(1, 245954068, 'DM1997', 'FIREBALL', 'Roberto', 'RobertB@gmail.com', 1, 'A good DM'),
	(2, 469830, 'Mia22', 'Nya', 'Mia', 'Mieechka@gmail.com', 0, 'Hello world'),
