...
<head>
  ...
  <body>
    ...
    <a href = "Race_template.php?page=1">
    <div class = "container-first">
    <button class = "classbox">
      <p class = "buttontext">Banshee</p>
    </button>
    </div>
    </a>
    <a href = "Race_template.php?page=2">
      <div class = "container">
      <button class = "classbox">
        <p class = "buttontext">Leprechaun</p>
      </button>
      </div>
      </a>
      <a href = "Race_template.php?page=3">
        <div class = "container">
        <button class = "classbox">
          <p class = "buttontext">Imp</p>
        </button>
        </div>
        </a>
    <footer class = "footer">
