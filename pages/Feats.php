...
<head>
  ...
  <header class = "header"> 
    ...
    <a href = "Feat_template.php?page=1">
    <div class = "container-first">
    <button class = "classbox">
      <p class = "buttontext">Demon contract</p>
    </button>
    </div>
    </a>
    <a href = "Feat_template.php?page=2">
      <div class = "container">
      <button class = "classbox">
        <p class = "buttontext">sigil of nature</p>
      </button>
      </div>
    </a>
      <a href = "Feat_template.php?page=3">
        <div class = "container">
        <button class = "classbox">
          <p class = "buttontext">heavy</p>
        </button>
        </div>
      </a>
    <footer class = "footer">
