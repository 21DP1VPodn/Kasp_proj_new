...
<head>
  ...
  <header class = "header"> 
    ...
    <a href = "Backstory_template.php?page=1">
    <div class = "container-first">
    <button class = "classbox">
      <p class = "buttontext">deserter</p>
    </button>
    </div>
    </a>
    <a href = "Backstory_template.php?page=2">
      <div class = "container">
      <button class = "classbox">
        <p class = "buttontext">fallen through planes</p>
      </button>
      </div>
      </a>
      <a href = 'Backstory_template.php?page=3'>
        <div class = "container">
        <button class = "classbox">
          <p class = "buttontext">monster prey</p>
        </button>
        </div>
        </a>
    <footer class = "footer">
